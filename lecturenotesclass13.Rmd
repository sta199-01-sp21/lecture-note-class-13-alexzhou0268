...
```{r data_manhattan}
manhattan <- read_csv("~/R/lecture-note-class-13-alexzhou0268/manhattan.csv")
```
...
- Population: all mice
- Parameter of interest: proportion of mice that died while not on the treatment,regardless of the dose
- Sample: mice chosen for experiment
- Sample size: 10000
...
We are 95% confident that the proportion of mice that died while not on the treatment is between 0.69 and 0.793
...
I am 90% certain that the proportion of mouse who lived while on treatment is between 0.552 and 0.651
